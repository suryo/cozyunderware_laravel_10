        ...
        <a href="#">
          ...
          <span class="badge-sonar"></span>
            ...
            @if (Route::current()->getName() == 'register' && Auth::user() == null)
                <a href="{{ url('login') }}" class="" style="background-color:green"><i
                        class="fa fa-power-off"></i> Login</a>
            @elseif (Route::current()->getName() == 'login' && Auth::user() == null)
                <a href="{{ url('register') }}" class="" style="background-color:yellow">Belum punya akun?
                    Daftar...</a>
            @else
                <a href="{{ url('logout') }}" class="" style="background-color:red"><i
