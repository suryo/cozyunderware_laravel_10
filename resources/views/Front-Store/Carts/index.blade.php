        ...
        <div class="row">
                    ...
                    @foreach ($cart as $item)
                        <div class="row border-top border-bottom">
                            <div class="row main align-items-center">
                                ...
                                <div class="col">
                                    <div class="row text-muted">{{ $item->product->brand->product_brand }}</div>
                                    <div class="row">{{ $item->product->product_name }}</div>
                                </div>
                                <div class="col">
                                    <a href="{{ route('front.add.minus.cart', $item->product->id) }}">-</a><a href="#"
                                        class="border">{{ $item->quantity }}</a><a
                                        href="{{ route('front.add.cart', $item->product->id) }}">+</a>
                                </div>
                                <div class="col">Rp. {{ $item->total }}
                                    <span class="close"> <a
                                            href="{{ route('front.delete.cart', $item->id) }}">&#10005;</a></span>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="col-md-4 summary">
                ...
                <div class="row">
                    ...
                    <div class="col text-right">{{ App\Services\CartService::getUserCartCount() }}</div>
                </div>
                <hr>
                <div class="row">
